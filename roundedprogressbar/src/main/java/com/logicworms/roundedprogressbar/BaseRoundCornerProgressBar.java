...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    public void setupStyleable(Context context, AttributeSet attrs) {
        ...
        int colorBackgroundDefault = res.getColor(R.color.round_corner_progress_bar_background_default);
        colorBackground = typedArray.getColor(R.styleable.BaseRoundCornerProgressBar_rcBackgroundColor, colorBackgroundDefault);
        int colorProgressDefault = res.getColor(R.color.round_corner_progress_bar_progress_default);
        colorProgress = typedArray.getColor(R.styleable.BaseRoundCornerProgressBar_rcProgressColor, colorProgressDefault);
        int colorSecondaryProgressDefault = res.getColor(R.color.round_corner_progress_bar_secondary_progress_default);
